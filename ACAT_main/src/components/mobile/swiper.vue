                ...
                <swiper :options="swiperOptions" ref="mySwiper">
                    ...
                    <swiper-slide>
                        <div class="slide-item brief-wrapper">
                            ...
                            <div class="brief-button-wrapper">
                                <a class="brief-button" @click="jump"></a>
                            </div>
                        </div>
                    </swiper-slide>
                    ...
                    <swiper-slide>
                        <div class="slide-item pictrueWall">
                            ...
                            <div
                                class="pictrueWall-item pictrueWall-item-first"
                            >
                                <div class="pictrue">
                                    <img
                            ...
                            <div
                                class="pictrueWall-item pictrueWall-item-second"
                            >
                                <div class="text">
                            ...
                            <div
                                class="pictrueWall-item pictrueWall-item-third"
                            >
                                <div class="pictrue">
                                    <img
...
export default {
    ...
    methods: {
        mainPageAmination() {
            document.getElementsByClassName("logo-wrapper")[0].style.left =
                "-60px";
        },
        sketchPageAmination() {
...
.brief-pictrues-first {
    ...
    width: 10vw;
    height: 10vw;
    background-image: url("../../assets/mobile/book.jpg");
...
.brief-pictrues-second {
    ...
    height: 10vw;
    opacity: 0;
    background-image: url("../../assets/mobile/table.jpg");
    background-size: auto 100%;
    top: 15vw;
    right: 60vw;
    transform: scale(1);
...
.brief-pictrues-third {
    ...
    height: 10vw;
    opacity: 0;
    background-image: url("../../assets/mobile/entryEnv.jpg");
    background-size: auto 100%;
    top: 43vw;
    right: 30vw;
    transform: scale(1);
